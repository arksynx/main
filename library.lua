...
do
    if (#args > 0 and typeof(args[1]) == 'table') then
        ...
        if (typeof(theme) == 'string') then
            if (theme == 'allostra') then          -- red
                theme = {
                    Primary = Color3.fromRGB(255, 255, 255);
        Secondary = Color3.fromRGB(180, 180, 180);

        Window1 = Color3.fromRGB(15, 15, 15);
        Window2 = Color3.fromRGB(10, 10, 10);
        Window3 = Color3.fromRGB(20, 20, 20);

        Button1 = Color3.fromRGB(25, 25, 25);
        Button2 = Color3.fromRGB(35, 35, 35);
        Button3 = Color3.fromRGB(45, 45, 45);
        Button4 = Color3.fromRGB(55, 55, 55);

        Stroke = Color3.fromRGB(70, 70, 70);
        StrokeHover = Color3.fromRGB(120, 120, 120);

        Inset1 = Color3.fromRGB(8, 8, 8);
        Inset2 = Color3.fromRGB(4, 4, 4);
        Inset3 = Color3.fromRGB(12, 12, 12);
